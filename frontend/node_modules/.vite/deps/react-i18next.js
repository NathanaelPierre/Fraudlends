...
// node_modules/html-parse-stringify/dist/esm/html-parse-stringify.js
var voidElements = {
  area: true,
  base: true,
  br: true,
...
var hasValidReactChildren = (children) => getAsArray(children).every(import_react.isValidElement);
  ...
  const pushTranslatedJSX = (child, inner, mem, i, isVoid) => {
    if (child.dummy) {
      ...
      mem.push(...import_react.Children.map([child], (c) => {
        var _a;
        if (c.type === import_react.Fragment || ((_a = c.props) == null ? void 0 : _a.i18nIsDynamicList) !== void 0) {
          const freshProps = {
            key: i
          };
          if (c && c.props) {
...
function IcuTransWithoutContext({
  ...
  const t = tFromProps || ((_a = i18n.t) == null ? void 0 : _a.bind(i18n)) || ((k) => k);
  let namespaces = ns || t.ns || ((_b = i18n.options) == null ? void 0 : _b.defaultNS);
  namespaces = isString(namespaces) ? [namespaces] : namespaces || ["translation"];
...
var useTranslation = (ns, props = {}) => {
  ...
  const languageKey = (inst) => {
    var _a2;
    return `${inst.language}|${inst.resolvedLanguage}|${(_a2 = inst.languages) == null ? void 0 : _a2.join(",")}`;
  };
